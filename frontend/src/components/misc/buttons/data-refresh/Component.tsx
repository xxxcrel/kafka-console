...
import {REST_CACHE_DURATION_SEC} from '../../../../state/backendApi';
...
export const DataRefreshButton = observer(() => {
  ...
  const countStr =
    autoRefresh.maxRequestCount   // maybe we need to use the same 'no vertical expansion' trick:
  return (
    <>
      <Box>
        <Popover
