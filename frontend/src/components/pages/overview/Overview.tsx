...
class Overview extends PageComponent {
  ...
  render() {
    ...
    const renderIdColumn = (text: string, record: BrokerWithLogDirs) => {
    ...
    const version = overview.kafka?.version;
                      ...
                      ? [
                        {
                          size: 100,
                          header: 'Rack',
                          cell: ({row: {original: broker}}: { row: Row<BrokerWithLogDirs> }) =>
                            broker.rack,
                        },
                      ]
                      : []),
