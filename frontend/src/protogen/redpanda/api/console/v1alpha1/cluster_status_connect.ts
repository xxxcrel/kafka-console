 ...
 *
 * @generated from service redpanda.api.kconsole.v1alpha1.ClusterStatusService
 */
export const ClusterStatusService = {
  typeName: "redpanda.api.kconsole.v1alpha1.ClusterStatusService",
  methods: {
    /**
     * GetKafkaInfo returns general Kafka cluster information that can be
     * retrieved via the Kafka API.
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetKafkaInfo
     */
    getKafkaInfo: {
      name: "GetKafkaInfo",
     ...
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetKafkaAuthorizerInfo
     */
     ...
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetRedpandaInfo
     */
    getRedpandaInfo: {
    ...
    /**
     * @generated from rpc redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetRedpandaPartitionBalancerStatus
     */
     ...
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetConsoleInfo
     */
    getConsoleInfo: {
      name: "GetConsoleInfo",
     ...
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetKafkaConnectInfo
     */
    getKafkaConnectInfo: {
     ...
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetSchemaRegistryInfo
     */
