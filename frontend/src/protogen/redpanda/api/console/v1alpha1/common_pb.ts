...
// @generated from file redpanda/api/kconsole/v1alpha1/common.proto (package redpanda.api.kconsole.v1alpha1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum redpanda.api.kconsole.v1alpha1.CompressionType
 */
...
proto3.util.setEnumType(CompressionType, "redpanda.api.kconsole.v1alpha1.CompressionType", [
...
/**
 * @generated from enum redpanda.api.kconsole.v1alpha1.PayloadEncoding
 */
...
proto3.util.setEnumType(PayloadEncoding, "redpanda.api.kconsole.v1alpha1.PayloadEncoding", [
 ...
 *
 * @generated from message redpanda.api.kconsole.v1alpha1.KafkaRecordHeader
 */
export class KafkaRecordHeader extends Message<KafkaRecordHeader> {
  ...
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.KafkaRecordHeader";
...
/**
 * @generated from message redpanda.api.kconsole.v1alpha1.TroubleshootReport
 */
export class TroubleshootReport extends Message<TroubleshootReport> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.TroubleshootReport";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
