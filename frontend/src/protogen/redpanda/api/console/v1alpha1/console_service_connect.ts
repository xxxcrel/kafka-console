...
// @generated from file redpanda/api/kconsole/v1alpha1/console_service.proto (package redpanda.api.kconsole.v1alpha1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from service redpanda.api.kconsole.v1alpha1.ConsoleService
 */
export const ConsoleService = {
  typeName: "redpanda.api.kconsole.v1alpha1.ConsoleService",
  methods: {
    /**
     * ListMessages lists the messages according to the requested query.
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.ConsoleService.ListMessages
     */
    listMessages: {
      name: "ListMessages",
     ...
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.ConsoleService.PublishMessage
     */
    publishMessage: {
      name: "PublishMessage",
