...
// @generated from file redpanda/api/kconsole/v1alpha1/license.proto (package redpanda.api.kconsole.v1alpha1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message redpanda.api.kconsole.v1alpha1.License
 */
export class License extends Message<License> {
  /**
   * Source is where the license is used (e.g. Redpanda Cluster, Console).
   *
   * @generated from field: redpanda.api.kconsole.v1alpha1.License.Source source = 1;
   */
   ...
   *
   * @generated from field: redpanda.api.kconsole.v1alpha1.License.Type type = 2;
   */
  ...
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.License";
...
/**
 * @generated from enum redpanda.api.kconsole.v1alpha1.License.Source
 */
...
proto3.util.setEnumType(License_Source, "redpanda.api.kconsole.v1alpha1.License.Source", [
...
/**
 * @generated from enum redpanda.api.kconsole.v1alpha1.License.Type
 */
...
proto3.util.setEnumType(License_Type, "redpanda.api.kconsole.v1alpha1.License.Type", [
...
/**
 * @generated from message redpanda.api.kconsole.v1alpha1.ListLicensesRequest
 */
export class ListLicensesRequest extends Message<ListLicensesRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.ListLicensesRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message redpanda.api.kconsole.v1alpha1.ListLicensesResponse
 */
export class ListLicensesResponse extends Message<ListLicensesResponse> {
  /**
   * @generated from field: repeated redpanda.api.kconsole.v1alpha1.License licenses = 1;
   */
  licenses: License[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.ListLicensesResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message redpanda.api.kconsole.v1alpha1.SetLicenseRequest
 */
export class SetLicenseRequest extends Message<SetLicenseRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.SetLicenseRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message redpanda.api.kconsole.v1alpha1.SetLicenseResponse
 */
export class SetLicenseResponse extends Message<SetLicenseResponse> {
  /**
   * @generated from field: redpanda.api.kconsole.v1alpha1.License license = 1;
   */
  license?: License;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.SetLicenseResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message redpanda.api.kconsole.v1alpha1.ListEnterpriseFeaturesRequest
 */
export class ListEnterpriseFeaturesRequest extends Message<ListEnterpriseFeaturesRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.ListEnterpriseFeaturesRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message redpanda.api.kconsole.v1alpha1.ListEnterpriseFeaturesResponse
 */
export class ListEnterpriseFeaturesResponse extends Message<ListEnterpriseFeaturesResponse> {
   ...
   *
   * @generated from field: redpanda.api.kconsole.v1alpha1.ListEnterpriseFeaturesResponse.LicenseStatus license_status = 1;
   */
   ...
   *
   * @generated from field: repeated redpanda.api.kconsole.v1alpha1.ListEnterpriseFeaturesResponse.Feature features = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.ListEnterpriseFeaturesResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum redpanda.api.kconsole.v1alpha1.ListEnterpriseFeaturesResponse.LicenseStatus
 */
...
proto3.util.setEnumType(ListEnterpriseFeaturesResponse_LicenseStatus, "redpanda.api.kconsole.v1alpha1.ListEnterpriseFeaturesResponse.LicenseStatus", [
 ...
 *
 * @generated from message redpanda.api.kconsole.v1alpha1.ListEnterpriseFeaturesResponse.Feature
 */
export class ListEnterpriseFeaturesResponse_Feature extends Message<ListEnterpriseFeaturesResponse_Feature> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.ListEnterpriseFeaturesResponse.Feature";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
