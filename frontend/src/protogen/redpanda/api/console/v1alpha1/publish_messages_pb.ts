...
// @generated from file redpanda/api/kconsole/v1alpha1/publish_messages.proto (package redpanda.api.kconsole.v1alpha1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message redpanda.api.kconsole.v1alpha1.PublishMessageRequest
 */
export class PublishMessageRequest extends Message<PublishMessageRequest> {
   ...
   *
   * @generated from field: redpanda.api.kconsole.v1alpha1.CompressionType compression = 3;
   */
   ...
   *
   * @generated from field: repeated redpanda.api.kconsole.v1alpha1.KafkaRecordHeader headers = 5;
   */
  headers: KafkaRecordHeader[] = [];

  /**
   * @generated from field: redpanda.api.kconsole.v1alpha1.PublishMessagePayloadOptions key = 6;
   */
  key?: PublishMessagePayloadOptions;

  /**
   * @generated from field: redpanda.api.kconsole.v1alpha1.PublishMessagePayloadOptions value = 7;
   */
  ...
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.PublishMessageRequest";
...
/**
 * @generated from message redpanda.api.kconsole.v1alpha1.PublishMessagePayloadOptions
 */
export class PublishMessagePayloadOptions extends Message<PublishMessagePayloadOptions> {
  /**
   * Payload encoding to use.
   *
   * @generated from field: redpanda.api.kconsole.v1alpha1.PayloadEncoding encoding = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.PublishMessagePayloadOptions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message redpanda.api.kconsole.v1alpha1.PublishMessageResponse
 */
export class PublishMessageResponse extends Message<PublishMessageResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "redpanda.api.kconsole.v1alpha1.PublishMessageResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "topic", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "partition_id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
