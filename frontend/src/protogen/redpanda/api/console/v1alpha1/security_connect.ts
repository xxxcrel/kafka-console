...
/**
 * @generated from service redpanda.api.kconsole.v1alpha1.SecurityService
 */
export const SecurityService = {
  typeName: "redpanda.api.kconsole.v1alpha1.SecurityService",
  methods: {
    /**
     * ListRoles lists all the roles based on optional filter.
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.SecurityService.ListRoles
     */
    listRoles: {
      name: "ListRoles",
      I: ListRolesRequest,
    ...
    /**
     * @generated from rpc redpanda.api.kconsole.v1alpha1.SecurityService.CreateRole
     */
    createRole: {
      name: "CreateRole",
      I: CreateRoleRequest,
     ...
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.SecurityService.GetRole
     */
    getRole: {
      name: "GetRole",
      I: GetRoleRequest,
     ...
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.SecurityService.DeleteRole
     */
    deleteRole: {
      name: "DeleteRole",
      I: DeleteRoleRequest,
     ...
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.SecurityService.ListRoleMembers
     */
    listRoleMembers: {
     ...
     *
     * @generated from rpc redpanda.api.kconsole.v1alpha1.SecurityService.UpdateRoleMembership
     */
