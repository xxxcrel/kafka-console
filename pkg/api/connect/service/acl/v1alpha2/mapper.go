...
func (k *kafkaClientMapper) aclCreateRequestToKafka(req *v1alpha2.CreateACLRequest) (*kmsg.CreateACLsRequest, error) {
...
func (k *kafkaClientMapper) listACLFilterToDescribeACLKafka(filter *v1alpha2.ListACLsRequest_Filter) (*kmsg.DescribeACLsRequest, error) {
...
func (k *kafkaClientMapper) describeACLsResourceToProto(res kmsg.DescribeACLsResponseResource) (*v1alpha2.ListACLsResponse_Resource, error) {
	...
	aclsProto := make([]*v1alpha2.ListACLsResponse_Policy, len(res.ACLs))
...
func (k *kafkaClientMapper) describeACLsResponseResourceACLToProto(resource kmsg.DescribeACLsResponseResourceACL) (*v1alpha2.ListACLsResponse_Policy, error) {
	...
	return &v1alpha2.ListACLsResponse_Policy{
...
func (k *kafkaClientMapper) deleteACLFilterToDeleteACLKafka(filter *v1alpha2.DeleteACLsRequest_Filter) (*kmsg.DeleteACLsRequest, error) {
...
func (k *kafkaClientMapper) deleteACLMatchingResultsToProtos(acls []kmsg.DeleteACLsResponseResultMatchingACL) ([]*v1alpha2.DeleteACLsResponse_MatchingACL, error) {
	matchingACLs := make([]*v1alpha2.DeleteACLsResponse_MatchingACL, 0, len(acls))
...
func (k *kafkaClientMapper) deleteACLMatchingResultToProto(acl kmsg.DeleteACLsResponseResultMatchingACL) (*v1alpha2.DeleteACLsResponse_MatchingACL, error) {
	...
	return &v1alpha2.DeleteACLsResponse_MatchingACL{
		ResourceType:        resourceType,
