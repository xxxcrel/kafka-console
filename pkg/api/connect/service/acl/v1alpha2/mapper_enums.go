...
func (*kafkaClientMapper) aclOperationToKafka(operation v1alpha2.ACL_Operation) (kmsg.ACLOperation, error) {
	switch operation {
...
func (*kafkaClientMapper) aclOperationToProto(operation kmsg.ACLOperation) (v1alpha2.ACL_Operation, error) {
	switch operation {
	case kmsg.ACLOperationAny:
		return v1alpha2.ACL_OPERATION_ANY, nil
	case kmsg.ACLOperationAll:
		return v1alpha2.ACL_OPERATION_ALL, nil
	case kmsg.ACLOperationRead:
		return v1alpha2.ACL_OPERATION_READ, nil
	case kmsg.ACLOperationWrite:
		return v1alpha2.ACL_OPERATION_WRITE, nil
	case kmsg.ACLOperationCreate:
		return v1alpha2.ACL_OPERATION_CREATE, nil
	case kmsg.ACLOperationDelete:
		return v1alpha2.ACL_OPERATION_DELETE, nil
	case kmsg.ACLOperationAlter:
		return v1alpha2.ACL_OPERATION_ALTER, nil
	case kmsg.ACLOperationDescribe:
		return v1alpha2.ACL_OPERATION_DESCRIBE, nil
	case kmsg.ACLOperationClusterAction:
		return v1alpha2.ACL_OPERATION_CLUSTER_ACTION, nil
	case kmsg.ACLOperationDescribeConfigs:
		return v1alpha2.ACL_OPERATION_DESCRIBE_CONFIGS, nil
	case kmsg.ACLOperationAlterConfigs:
		return v1alpha2.ACL_OPERATION_ALTER_CONFIGS, nil
	case kmsg.ACLOperationIdempotentWrite:
		return v1alpha2.ACL_OPERATION_IDEMPOTENT_WRITE, nil
	case kmsg.ACLOperationCreateTokens:
		return v1alpha2.ACL_OPERATION_CREATE_TOKENS, nil
	case kmsg.ACLOperationDescribeTokens:
		return v1alpha2.ACL_OPERATION_DESCRIBE_TOKENS, nil
	default:
		return v1alpha2.ACL_OPERATION_UNSPECIFIED, fmt.Errorf("failed to map given ACL operation %v to proto", operation.String())
	}
}

func (*kafkaClientMapper) aclPermissionTypeToKafka(permissionType v1alpha2.ACL_PermissionType) (kmsg.ACLPermissionType, error) {
...
func (*kafkaClientMapper) aclPermissionTypeToProto(permissionType kmsg.ACLPermissionType) (v1alpha2.ACL_PermissionType, error) {
	switch permissionType {
	case kmsg.ACLPermissionTypeAny:
		return v1alpha2.ACL_PERMISSION_TYPE_ANY, nil
	case kmsg.ACLPermissionTypeDeny:
		return v1alpha2.ACL_PERMISSION_TYPE_DENY, nil
	case kmsg.ACLPermissionTypeAllow:
		return v1alpha2.ACL_PERMISSION_TYPE_ALLOW, nil
	default:
		return v1alpha2.ACL_PERMISSION_TYPE_UNSPECIFIED, fmt.Errorf("failed to map given ACL permission type %v to proto", permissionType.String())
	}
}

func (*kafkaClientMapper) aclResourcePatternTypeToKafka(patternType v1alpha2.ACL_ResourcePatternType) (kmsg.ACLResourcePatternType, error) {
	switch patternType {
...
func (*kafkaClientMapper) aclResourcePatternTypeToProto(patternType kmsg.ACLResourcePatternType) (v1alpha2.ACL_ResourcePatternType, error) {
	switch patternType {
	case kmsg.ACLResourcePatternTypeAny:
		return v1alpha2.ACL_RESOURCE_PATTERN_TYPE_ANY, nil
	case kmsg.ACLResourcePatternTypeMatch:
		return v1alpha2.ACL_RESOURCE_PATTERN_TYPE_MATCH, nil
	case kmsg.ACLResourcePatternTypeLiteral:
		return v1alpha2.ACL_RESOURCE_PATTERN_TYPE_LITERAL, nil
	case kmsg.ACLResourcePatternTypePrefixed:
		return v1alpha2.ACL_RESOURCE_PATTERN_TYPE_PREFIXED, nil
	default:
		return v1alpha2.ACL_RESOURCE_PATTERN_TYPE_UNSPECIFIED, fmt.Errorf("failed to map given ACL resource pattern type %v to proto", patternType.String())
	}
}

func (*kafkaClientMapper) aclResourceTypeToKafka(resourceType v1alpha2.ACL_ResourceType) (kmsg.ACLResourceType, error) {
	switch resourceType {
...
func (*kafkaClientMapper) aclResourceTypeToProto(resourceType kmsg.ACLResourceType) (v1alpha2.ACL_ResourceType, error) {
	switch resourceType {
	case kmsg.ACLResourceTypeAny:
		return v1alpha2.ACL_RESOURCE_TYPE_ANY, nil
	case kmsg.ACLResourceTypeTopic:
		return v1alpha2.ACL_RESOURCE_TYPE_TOPIC, nil
	case kmsg.ACLResourceTypeGroup:
		return v1alpha2.ACL_RESOURCE_TYPE_GROUP, nil
	case kmsg.ACLResourceTypeCluster:
		return v1alpha2.ACL_RESOURCE_TYPE_CLUSTER, nil
	case kmsg.ACLResourceTypeTransactionalId:
		return v1alpha2.ACL_RESOURCE_TYPE_TRANSACTIONAL_ID, nil
	case kmsg.ACLResourceTypeUser:
		return v1alpha2.ACL_RESOURCE_TYPE_USER, nil
	default:
		return v1alpha2.ACL_RESOURCE_TYPE_UNSPECIFIED, fmt.Errorf("failed to map given ACL resource type %q to proto", resourceType.String())
	}
}
