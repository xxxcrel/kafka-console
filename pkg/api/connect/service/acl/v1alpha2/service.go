...
var _ dataplanev1alpha2connect.ACLServiceHandler = (*Service)(nil)
...
func (s *Service) ListACLs(ctx context.Context, req *connect.Request[v1alpha2.ListACLsRequest]) (*connect.Response[v1alpha2.ListACLsResponse], error) {
	...
	resources := make([]*v1alpha2.ListACLsResponse_Resource, len(kafkaRes.Resources))
	...
	return connect.NewResponse(&v1alpha2.ListACLsResponse{Resources: resources}), nil
}

// CreateACL implements the handler for the create ACL endpoint.
func (s *Service) CreateACL(ctx context.Context, req *connect.Request[v1alpha2.CreateACLRequest]) (*connect.Response[v1alpha2.CreateACLResponse], error) {
	...
	connectResponse := connect.NewResponse(&v1alpha2.CreateACLResponse{})
...
func (s *Service) DeleteACLs(ctx context.Context, req *connect.Request[v1alpha2.DeleteACLsRequest]) (*connect.Response[v1alpha2.DeleteACLsResponse], error) {
	...
	return connect.NewResponse(&v1alpha2.DeleteACLsResponse{MatchingAcls: matchingACLsProto}), nil
}
