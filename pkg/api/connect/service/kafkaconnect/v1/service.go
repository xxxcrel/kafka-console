...
// Package kafkaconnect implements the KafkaConnect interface for the ConnectRPC API.
...
var _ dataplanev1connect.KafkaConnectServiceHandler = (*Service)(nil)
...
func (s *Service) ListConnectors(ctx context.Context, req *connect.Request[v1.ListConnectorsRequest]) (*connect.Response[v1.ListConnectorsResponse], error) {
	...
	if req.Msg.GetPageSize() > 0 {
		...
		page, nextPageToken, err := pagination.SliceToPaginatedWithToken(connectors, int(req.Msg.GetPageSize()), req.Msg.GetPageToken(), "name", func(x *v1.ListConnectorsResponse_ConnectorInfoStatus) string {
			return x.GetName()
		})
		if err != nil {
			return nil, apierrors.NewConnectError(
...
func (s *Service) CreateConnector(ctx context.Context, req *connect.Request[v1.CreateConnectorRequest]) (*connect.Response[v1.CreateConnectorResponse], error) {
	...
	res := connect.NewResponse(&v1.CreateConnectorResponse{
...
func (s *Service) GetConnector(ctx context.Context, req *connect.Request[v1.GetConnectorRequest]) (*connect.Response[v1.GetConnectorResponse], error) {
	httpRes, err := s.connectSvc.GetConnectorInfo(ctx, req.Msg.ClusterName, req.Msg.Name)
	if err != nil {
		return nil, s.matchError(err)
	}

	res := connect.NewResponse(&v1.GetConnectorResponse{
...
func (s *Service) GetConnectorStatus(ctx context.Context, req *connect.Request[v1.GetConnectorStatusRequest]) (*connect.Response[v1.GetConnectorStatusResponse], error) {
	...
	res := connect.NewResponse(&v1.GetConnectorStatusResponse{
		Status: status,
	})
...
func (s *Service) ResumeConnector(ctx context.Context, req *connect.Request[v1.ResumeConnectorRequest]) (*connect.Response[emptypb.Empty], error) {
...
func (s *Service) PauseConnector(ctx context.Context, req *connect.Request[v1.PauseConnectorRequest]) (*connect.Response[emptypb.Empty], error) {
...
func (s *Service) DeleteConnector(ctx context.Context, req *connect.Request[v1.DeleteConnectorRequest]) (*connect.Response[emptypb.Empty], error) {
...
// and response bodies
func (s *Service) RestartConnector(ctx context.Context, req *connect.Request[v1.RestartConnectorRequest]) (*connect.Response[emptypb.Empty], error) {
...
func (s *Service) StopConnector(ctx context.Context, req *connect.Request[v1.StopConnectorRequest]) (*connect.Response[emptypb.Empty], error) {
...
func (s *Service) ListConnectClusters(ctx context.Context, _ *connect.Request[v1.ListConnectClustersRequest]) (*connect.Response[v1.ListConnectClustersResponse], error) {
	...
	return connect.NewResponse(&v1.ListConnectClustersResponse{
		Clusters: clustersProto,
	}), nil
}

// GetConnectCluster implements the get connector info operation
func (s *Service) GetConnectCluster(ctx context.Context, req *connect.Request[v1.GetConnectClusterRequest]) (*connect.Response[v1.GetConnectClusterResponse], error) {
	response, httpErr := s.connectSvc.GetClusterInfo(ctx, req.Msg.ClusterName)
	if httpErr != nil {
		return nil, s.matchError(httpErr)
	}
	return connect.NewResponse(&v1.GetConnectClusterResponse{
		Cluster: s.mapper.clusterInfoToProto(response),
	}), nil
}

// UpsertConnector implements the handler for the upsert connector operation
func (s *Service) UpsertConnector(ctx context.Context, req *connect.Request[v1.UpsertConnectorRequest]) (*connect.Response[v1.UpsertConnectorResponse], error) {
	...
	res := connect.NewResponse(&v1.UpsertConnectorResponse{
...
func (s *Service) GetConnectorConfig(ctx context.Context, req *connect.Request[v1.GetConnectorConfigRequest]) (*connect.Response[v1.GetConnectorConfigResponse], error) {
	config, err := s.connectSvc.GetConnectorConfig(ctx, req.Msg.ClusterName, req.Msg.Name)
	if err != nil {
		return nil, s.matchError(err)
	}
	return connect.NewResponse(&v1.GetConnectorConfigResponse{
		Config: config,
	}), nil
}
...
func (s *Service) ListConnectorTopics(ctx context.Context, req *connect.Request[v1.ListConnectorTopicsRequest]) (*connect.Response[v1.ListConnectorTopicsResponse], error) {
	connectorTopics, err := s.connectSvc.ListConnectorTopics(ctx, req.Msg.ClusterName, req.Msg.Name)
	if err != nil {
		return nil, s.matchError(err)
	}
	return connect.NewResponse(&v1.ListConnectorTopicsResponse{
...
// reset.
func (s *Service) ResetConnectorTopics(ctx context.Context, req *connect.Request[v1.ResetConnectorTopicsRequest]) (*connect.Response[emptypb.Empty], error) {
