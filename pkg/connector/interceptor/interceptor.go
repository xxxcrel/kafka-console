...
import (
	...
	"github.com/xxxcrel/kafka-console/pkg/connector/guide"
	"github.com/xxxcrel/kafka-console/pkg/connector/model"
	"github.com/xxxcrel/kafka-console/pkg/connector/patch"
)
...
func CommunityPatches() []patch.ConfigPatch {
	return []patch.ConfigPatch{
		...
		patch.NewConfigPatchDebeziumSQLServerSource(),
...
func CommunityGuides(opts ...guide.Option) []guide.Guide {
	return []guide.Guide{
		...
		guide.NewDebeziumMySQLGuide(guide.WithKafkaConnectValidateToConsoleHookFn(KafkaConnectToConsoleDebeziumMysqlSourceHook),
			guide.WithKafkaConnectValidateToConsoleHookFn(KafkaConnectToConsoleCloudEventsConverterHook)),
		guide.NewDebeziumSQLServerGuide(guide.WithKafkaConnectValidateToConsoleHookFn(KafkaConnectToConsoleDebeziumSQLServerSourceHook),
			guide.WithKafkaConnectValidateToConsoleHookFn(KafkaConnectToConsoleCloudEventsConverterHook)),
