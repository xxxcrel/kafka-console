...
// https://github.com/xxxcrel/redpanda/tree/dev/src/v/pandaproxy/schema_registry/protobuf
// https://github.com/xxxcrel/redpanda/blob/dev/src/v/pandaproxy/schema_registry/test/compatibility_protobuf.cc
//
