...
const (
	...
	AuthenticationServiceName = "redpanda.api.kconsole.v1alpha1.AuthenticationService"
)
...
const (
	...
	AuthenticationServiceLoginSaslScramProcedure = "/redpanda.api.kconsole.v1alpha1.AuthenticationService/LoginSaslScram"
	...
	AuthenticationServiceListAuthenticationMethodsProcedure = "/redpanda.api.kconsole.v1alpha1.AuthenticationService/ListAuthenticationMethods"
	// AuthenticationServiceGetIdentityProcedure is the fully-qualified name of the
	// AuthenticationService's GetIdentity RPC.
	AuthenticationServiceGetIdentityProcedure = "/redpanda.api.kconsole.v1alpha1.AuthenticationService/GetIdentity"
	...
	AuthenticationServiceListConsoleUsersProcedure = "/redpanda.api.kconsole.v1alpha1.AuthenticationService/ListConsoleUsers"
)
...
// redpanda.api.kconsole.v1alpha1.AuthenticationService service.
...
// redpanda.api.kconsole.v1alpha1.AuthenticationService service. By default, it uses the Connect
...
// LoginSaslScram calls redpanda.api.kconsole.v1alpha1.AuthenticationService.LoginSaslScram.
...
// redpanda.api.kconsole.v1alpha1.AuthenticationService.ListAuthenticationMethods.
...
// GetIdentity calls redpanda.api.kconsole.v1alpha1.AuthenticationService.GetIdentity.
...
// ListConsoleUsers calls redpanda.api.kconsole.v1alpha1.AuthenticationService.ListConsoleUsers.
...
func NewAuthenticationServiceHandler(svc AuthenticationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.kconsole.v1alpha1.AuthenticationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthenticationServiceHandler) LoginSaslScram(context.Context, *connect.Request[v1alpha1.LoginSaslScramRequest]) (*connect.Response[v1alpha1.LoginSaslScramResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.AuthenticationService.LoginSaslScram is not implemented"))
}
...
func (UnimplementedAuthenticationServiceHandler) ListAuthenticationMethods(context.Context, *connect.Request[v1alpha1.ListAuthenticationMethodsRequest]) (*connect.Response[v1alpha1.ListAuthenticationMethodsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.AuthenticationService.ListAuthenticationMethods is not implemented"))
}
...
func (UnimplementedAuthenticationServiceHandler) GetIdentity(context.Context, *connect.Request[v1alpha1.GetIdentityRequest]) (*connect.Response[v1alpha1.GetIdentityResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.AuthenticationService.GetIdentity is not implemented"))
}
...
func (UnimplementedAuthenticationServiceHandler) ListConsoleUsers(context.Context, *connect.Request[v1alpha1.ListConsoleUsersRequest]) (*connect.Response[v1alpha1.ListConsoleUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.AuthenticationService.ListConsoleUsers is not implemented"))
}
