...
const (
	...
	ClusterStatusServiceName = "redpanda.api.kconsole.v1alpha1.ClusterStatusService"
)
...
const (
	...
	ClusterStatusServiceGetKafkaInfoProcedure = "/redpanda.api.kconsole.v1alpha1.ClusterStatusService/GetKafkaInfo"
	...
	ClusterStatusServiceGetKafkaAuthorizerInfoProcedure = "/redpanda.api.kconsole.v1alpha1.ClusterStatusService/GetKafkaAuthorizerInfo"
	...
	ClusterStatusServiceGetRedpandaInfoProcedure = "/redpanda.api.kconsole.v1alpha1.ClusterStatusService/GetRedpandaInfo"
	...
	ClusterStatusServiceGetRedpandaPartitionBalancerStatusProcedure = "/redpanda.api.kconsole.v1alpha1.ClusterStatusService/GetRedpandaPartitionBalancerStatus"
	// ClusterStatusServiceGetConsoleInfoProcedure is the fully-qualified name of the
	// ClusterStatusService's GetConsoleInfo RPC.
	ClusterStatusServiceGetConsoleInfoProcedure = "/redpanda.api.kconsole.v1alpha1.ClusterStatusService/GetConsoleInfo"
	...
	ClusterStatusServiceGetKafkaConnectInfoProcedure = "/redpanda.api.kconsole.v1alpha1.ClusterStatusService/GetKafkaConnectInfo"
	...
	ClusterStatusServiceGetSchemaRegistryInfoProcedure = "/redpanda.api.kconsole.v1alpha1.ClusterStatusService/GetSchemaRegistryInfo"
)
...
// ClusterStatusServiceClient is a client for the redpanda.api.kconsole.v1alpha1.ClusterStatusService
// service.
...
// redpanda.api.kconsole.v1alpha1.ClusterStatusService service. By default, it uses the Connect
...
// GetKafkaInfo calls redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetKafkaInfo.
...
// redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetKafkaAuthorizerInfo.
...
// GetRedpandaInfo calls redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetRedpandaInfo.
...
// redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetRedpandaPartitionBalancerStatus.
...
// GetConsoleInfo calls redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetConsoleInfo.
...
// GetKafkaConnectInfo calls redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetKafkaConnectInfo.
...
// redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetSchemaRegistryInfo.
...
// redpanda.api.kconsole.v1alpha1.ClusterStatusService service.
...
func NewClusterStatusServiceHandler(svc ClusterStatusServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.kconsole.v1alpha1.ClusterStatusService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedClusterStatusServiceHandler) GetKafkaInfo(context.Context, *connect.Request[v1alpha1.GetKafkaInfoRequest]) (*connect.Response[v1alpha1.GetKafkaInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetKafkaInfo is not implemented"))
}
...
func (UnimplementedClusterStatusServiceHandler) GetKafkaAuthorizerInfo(context.Context, *connect.Request[v1alpha1.GetKafkaAuthorizerInfoRequest]) (*connect.Response[v1alpha1.GetKafkaAuthorizerInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetKafkaAuthorizerInfo is not implemented"))
}
...
func (UnimplementedClusterStatusServiceHandler) GetRedpandaInfo(context.Context, *connect.Request[v1alpha1.GetRedpandaInfoRequest]) (*connect.Response[v1alpha1.GetRedpandaInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetRedpandaInfo is not implemented"))
}
...
func (UnimplementedClusterStatusServiceHandler) GetRedpandaPartitionBalancerStatus(context.Context, *connect.Request[v1alpha1.GetRedpandaPartitionBalancerStatusRequest]) (*connect.Response[v1alpha1.GetRedpandaPartitionBalancerStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetRedpandaPartitionBalancerStatus is not implemented"))
}
...
func (UnimplementedClusterStatusServiceHandler) GetConsoleInfo(context.Context, *connect.Request[v1alpha1.GetConsoleInfoRequest]) (*connect.Response[v1alpha1.GetConsoleInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetConsoleInfo is not implemented"))
}
...
func (UnimplementedClusterStatusServiceHandler) GetKafkaConnectInfo(context.Context, *connect.Request[v1alpha1.GetKafkaConnectInfoRequest]) (*connect.Response[v1alpha1.GetKafkaConnectInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetKafkaConnectInfo is not implemented"))
}
...
func (UnimplementedClusterStatusServiceHandler) GetSchemaRegistryInfo(context.Context, *connect.Request[v1alpha1.GetSchemaRegistryInfoRequest]) (*connect.Response[v1alpha1.GetSchemaRegistryInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.ClusterStatusService.GetSchemaRegistryInfo is not implemented"))
}
