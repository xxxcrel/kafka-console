...
const (
	...
	ConsoleServiceName = "redpanda.api.kconsole.v1alpha1.ConsoleService"
)
...
const (
	...
	// ListMessages RPC.
	ConsoleServiceListMessagesProcedure = "/redpanda.api.kconsole.v1alpha1.ConsoleService/ListMessages"
	// ConsoleServicePublishMessageProcedure is the fully-qualified name of the ConsoleService's
	// PublishMessage RPC.
	ConsoleServicePublishMessageProcedure = "/redpanda.api.kconsole.v1alpha1.ConsoleService/PublishMessage"
)
...
// ConsoleServiceClient is a client for the redpanda.api.kconsole.v1alpha1.ConsoleService service.
...
// NewConsoleServiceClient constructs a client for the redpanda.api.kconsole.v1alpha1.ConsoleService
...
// ListMessages calls redpanda.api.kconsole.v1alpha1.ConsoleService.ListMessages.
...
// PublishMessage calls redpanda.api.kconsole.v1alpha1.ConsoleService.PublishMessage.
...
// ConsoleServiceHandler is an implementation of the redpanda.api.kconsole.v1alpha1.ConsoleService
// service.
...
func NewConsoleServiceHandler(svc ConsoleServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.kconsole.v1alpha1.ConsoleService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedConsoleServiceHandler) ListMessages(context.Context, *connect.Request[v1alpha1.ListMessagesRequest], *connect.ServerStream[v1alpha1.ListMessagesResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.ConsoleService.ListMessages is not implemented"))
}
...
func (UnimplementedConsoleServiceHandler) PublishMessage(context.Context, *connect.Request[v1alpha1.PublishMessageRequest]) (*connect.Response[v1alpha1.PublishMessageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.ConsoleService.PublishMessage is not implemented"))
}
