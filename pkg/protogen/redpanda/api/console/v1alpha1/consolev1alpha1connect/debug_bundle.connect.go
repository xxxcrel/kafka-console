...
const (
	...
	DebugBundleServiceName = "redpanda.api.kconsole.v1alpha1.DebugBundleService"
)
...
const (
	...
	DebugBundleServiceGetClusterHealthProcedure = "/redpanda.api.kconsole.v1alpha1.DebugBundleService/GetClusterHealth"
	...
	DebugBundleServiceCreateDebugBundleProcedure = "/redpanda.api.kconsole.v1alpha1.DebugBundleService/CreateDebugBundle"
	...
	DebugBundleServiceGetDebugBundleStatusProcedure = "/redpanda.api.kconsole.v1alpha1.DebugBundleService/GetDebugBundleStatus"
	...
	DebugBundleServiceCancelDebugBundleProcessProcedure = "/redpanda.api.kconsole.v1alpha1.DebugBundleService/CancelDebugBundleProcess"
	...
	DebugBundleServiceDeleteDebugBundleFileProcedure = "/redpanda.api.kconsole.v1alpha1.DebugBundleService/DeleteDebugBundleFile"
)
...
// DebugBundleServiceClient is a client for the redpanda.api.kconsole.v1alpha1.DebugBundleService
// service.
...
// redpanda.api.kconsole.v1alpha1.DebugBundleService service. By default, it uses the Connect
...
// GetClusterHealth calls redpanda.api.kconsole.v1alpha1.DebugBundleService.GetClusterHealth.
...
// CreateDebugBundle calls redpanda.api.kconsole.v1alpha1.DebugBundleService.CreateDebugBundle.
...
// GetDebugBundleStatus calls redpanda.api.kconsole.v1alpha1.DebugBundleService.GetDebugBundleStatus.
...
// redpanda.api.kconsole.v1alpha1.DebugBundleService.CancelDebugBundleProcess.
...
// redpanda.api.kconsole.v1alpha1.DebugBundleService.DeleteDebugBundleFile.
...
// redpanda.api.kconsole.v1alpha1.DebugBundleService service.
...
func NewDebugBundleServiceHandler(svc DebugBundleServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.kconsole.v1alpha1.DebugBundleService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDebugBundleServiceHandler) GetClusterHealth(context.Context, *connect.Request[v1alpha1.GetClusterHealthRequest]) (*connect.Response[v1alpha1.GetClusterHealthResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.DebugBundleService.GetClusterHealth is not implemented"))
}
...
func (UnimplementedDebugBundleServiceHandler) CreateDebugBundle(context.Context, *connect.Request[v1alpha1.CreateDebugBundleRequest]) (*connect.Response[v1alpha1.CreateDebugBundleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.DebugBundleService.CreateDebugBundle is not implemented"))
}
...
func (UnimplementedDebugBundleServiceHandler) GetDebugBundleStatus(context.Context, *connect.Request[v1alpha1.GetDebugBundleStatusRequest]) (*connect.Response[v1alpha1.GetDebugBundleStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.DebugBundleService.GetDebugBundleStatus is not implemented"))
}
...
func (UnimplementedDebugBundleServiceHandler) CancelDebugBundleProcess(context.Context, *connect.Request[v1alpha1.CancelDebugBundleProcessRequest]) (*connect.Response[v1alpha1.CancelDebugBundleProcessResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.DebugBundleService.CancelDebugBundleProcess is not implemented"))
}
...
func (UnimplementedDebugBundleServiceHandler) DeleteDebugBundleFile(context.Context, *connect.Request[v1alpha1.DeleteDebugBundleFileRequest]) (*connect.Response[v1alpha1.DeleteDebugBundleFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.DebugBundleService.DeleteDebugBundleFile is not implemented"))
}
