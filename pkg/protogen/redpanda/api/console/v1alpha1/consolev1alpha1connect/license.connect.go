...
const (
	...
	LicenseServiceName = "redpanda.api.kconsole.v1alpha1.LicenseService"
)
...
const (
	...
	// ListLicenses RPC.
	LicenseServiceListLicensesProcedure = "/redpanda.api.kconsole.v1alpha1.LicenseService/ListLicenses"
	// LicenseServiceSetLicenseProcedure is the fully-qualified name of the LicenseService's SetLicense
	// RPC.
	LicenseServiceSetLicenseProcedure = "/redpanda.api.kconsole.v1alpha1.LicenseService/SetLicense"
	...
	LicenseServiceListEnterpriseFeaturesProcedure = "/redpanda.api.kconsole.v1alpha1.LicenseService/ListEnterpriseFeatures"
)
...
// LicenseServiceClient is a client for the redpanda.api.kconsole.v1alpha1.LicenseService service.
...
// NewLicenseServiceClient constructs a client for the redpanda.api.kconsole.v1alpha1.LicenseService
...
// ListLicenses calls redpanda.api.kconsole.v1alpha1.LicenseService.ListLicenses.
...
// SetLicense calls redpanda.api.kconsole.v1alpha1.LicenseService.SetLicense.
...
// ListEnterpriseFeatures calls redpanda.api.kconsole.v1alpha1.LicenseService.ListEnterpriseFeatures.
...
// LicenseServiceHandler is an implementation of the redpanda.api.kconsole.v1alpha1.LicenseService
// service.
...
func NewLicenseServiceHandler(svc LicenseServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.kconsole.v1alpha1.LicenseService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedLicenseServiceHandler) ListLicenses(context.Context, *connect.Request[v1alpha1.ListLicensesRequest]) (*connect.Response[v1alpha1.ListLicensesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.LicenseService.ListLicenses is not implemented"))
}
...
func (UnimplementedLicenseServiceHandler) SetLicense(context.Context, *connect.Request[v1alpha1.SetLicenseRequest]) (*connect.Response[v1alpha1.SetLicenseResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.LicenseService.SetLicense is not implemented"))
}
...
func (UnimplementedLicenseServiceHandler) ListEnterpriseFeatures(context.Context, *connect.Request[v1alpha1.ListEnterpriseFeaturesRequest]) (*connect.Response[v1alpha1.ListEnterpriseFeaturesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.LicenseService.ListEnterpriseFeatures is not implemented"))
}
