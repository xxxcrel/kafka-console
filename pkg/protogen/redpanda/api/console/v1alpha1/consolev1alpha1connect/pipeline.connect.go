...
const (
	...
	PipelineServiceName = "redpanda.api.kconsole.v1alpha1.PipelineService"
)
...
const (
	...
	// CreatePipeline RPC.
	PipelineServiceCreatePipelineProcedure = "/redpanda.api.kconsole.v1alpha1.PipelineService/CreatePipeline"
	// PipelineServiceGetPipelineProcedure is the fully-qualified name of the PipelineService's
	// GetPipeline RPC.
	PipelineServiceGetPipelineProcedure = "/redpanda.api.kconsole.v1alpha1.PipelineService/GetPipeline"
	// PipelineServiceDeletePipelineProcedure is the fully-qualified name of the PipelineService's
	// DeletePipeline RPC.
	PipelineServiceDeletePipelineProcedure = "/redpanda.api.kconsole.v1alpha1.PipelineService/DeletePipeline"
	// PipelineServiceListPipelinesProcedure is the fully-qualified name of the PipelineService's
	// ListPipelines RPC.
	PipelineServiceListPipelinesProcedure = "/redpanda.api.kconsole.v1alpha1.PipelineService/ListPipelines"
	// PipelineServiceUpdatePipelineProcedure is the fully-qualified name of the PipelineService's
	// UpdatePipeline RPC.
	PipelineServiceUpdatePipelineProcedure = "/redpanda.api.kconsole.v1alpha1.PipelineService/UpdatePipeline"
	// PipelineServiceStopPipelineProcedure is the fully-qualified name of the PipelineService's
	// StopPipeline RPC.
	PipelineServiceStopPipelineProcedure = "/redpanda.api.kconsole.v1alpha1.PipelineService/StopPipeline"
	// PipelineServiceStartPipelineProcedure is the fully-qualified name of the PipelineService's
	// StartPipeline RPC.
	PipelineServiceStartPipelineProcedure = "/redpanda.api.kconsole.v1alpha1.PipelineService/StartPipeline"
	...
	PipelineServiceGetPipelineServiceConfigSchemaProcedure = "/redpanda.api.kconsole.v1alpha1.PipelineService/GetPipelineServiceConfigSchema"
	...
	PipelineServiceGetPipelinesForSecretProcedure = "/redpanda.api.kconsole.v1alpha1.PipelineService/GetPipelinesForSecret"
	...
	PipelineServiceGetPipelinesBySecretsProcedure = "/redpanda.api.kconsole.v1alpha1.PipelineService/GetPipelinesBySecrets"
)
...
// PipelineServiceClient is a client for the redpanda.api.kconsole.v1alpha1.PipelineService service.
...
// redpanda.api.kconsole.v1alpha1.PipelineService service. By default, it uses the Connect protocol
...
// CreatePipeline calls redpanda.api.kconsole.v1alpha1.PipelineService.CreatePipeline.
...
// GetPipeline calls redpanda.api.kconsole.v1alpha1.PipelineService.GetPipeline.
...
// DeletePipeline calls redpanda.api.kconsole.v1alpha1.PipelineService.DeletePipeline.
...
// ListPipelines calls redpanda.api.kconsole.v1alpha1.PipelineService.ListPipelines.
...
// UpdatePipeline calls redpanda.api.kconsole.v1alpha1.PipelineService.UpdatePipeline.
...
// StopPipeline calls redpanda.api.kconsole.v1alpha1.PipelineService.StopPipeline.
...
// StartPipeline calls redpanda.api.kconsole.v1alpha1.PipelineService.StartPipeline.
...
// redpanda.api.kconsole.v1alpha1.PipelineService.GetPipelineServiceConfigSchema.
...
// GetPipelinesForSecret calls redpanda.api.kconsole.v1alpha1.PipelineService.GetPipelinesForSecret.
...
// GetPipelinesBySecrets calls redpanda.api.kconsole.v1alpha1.PipelineService.GetPipelinesBySecrets.
...
// PipelineServiceHandler is an implementation of the redpanda.api.kconsole.v1alpha1.PipelineService
// service.
...
func NewPipelineServiceHandler(svc PipelineServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.kconsole.v1alpha1.PipelineService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPipelineServiceHandler) CreatePipeline(context.Context, *connect.Request[v1alpha1.CreatePipelineRequest]) (*connect.Response[v1alpha1.CreatePipelineResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.PipelineService.CreatePipeline is not implemented"))
}
...
func (UnimplementedPipelineServiceHandler) GetPipeline(context.Context, *connect.Request[v1alpha1.GetPipelineRequest]) (*connect.Response[v1alpha1.GetPipelineResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.PipelineService.GetPipeline is not implemented"))
}
...
func (UnimplementedPipelineServiceHandler) DeletePipeline(context.Context, *connect.Request[v1alpha1.DeletePipelineRequest]) (*connect.Response[v1alpha1.DeletePipelineResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.PipelineService.DeletePipeline is not implemented"))
}
...
func (UnimplementedPipelineServiceHandler) ListPipelines(context.Context, *connect.Request[v1alpha1.ListPipelinesRequest]) (*connect.Response[v1alpha1.ListPipelinesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.PipelineService.ListPipelines is not implemented"))
}
...
func (UnimplementedPipelineServiceHandler) UpdatePipeline(context.Context, *connect.Request[v1alpha1.UpdatePipelineRequest]) (*connect.Response[v1alpha1.UpdatePipelineResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.PipelineService.UpdatePipeline is not implemented"))
}
...
func (UnimplementedPipelineServiceHandler) StopPipeline(context.Context, *connect.Request[v1alpha1.StopPipelineRequest]) (*connect.Response[v1alpha1.StopPipelineResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.PipelineService.StopPipeline is not implemented"))
}
...
func (UnimplementedPipelineServiceHandler) StartPipeline(context.Context, *connect.Request[v1alpha1.StartPipelineRequest]) (*connect.Response[v1alpha1.StartPipelineResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.PipelineService.StartPipeline is not implemented"))
}
...
func (UnimplementedPipelineServiceHandler) GetPipelineServiceConfigSchema(context.Context, *connect.Request[v1alpha1.GetPipelineServiceConfigSchemaRequest]) (*connect.Response[v1alpha1.GetPipelineServiceConfigSchemaResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.PipelineService.GetPipelineServiceConfigSchema is not implemented"))
}
...
func (UnimplementedPipelineServiceHandler) GetPipelinesForSecret(context.Context, *connect.Request[v1alpha1.GetPipelinesForSecretRequest]) (*connect.Response[v1alpha1.GetPipelinesForSecretResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.PipelineService.GetPipelinesForSecret is not implemented"))
}
...
func (UnimplementedPipelineServiceHandler) GetPipelinesBySecrets(context.Context, *connect.Request[v1alpha1.GetPipelinesBySecretsRequest]) (*connect.Response[v1alpha1.GetPipelinesBySecretsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.PipelineService.GetPipelinesBySecrets is not implemented"))
}
