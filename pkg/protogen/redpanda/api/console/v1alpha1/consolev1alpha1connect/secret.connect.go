...
const (
	...
	SecretServiceName = "redpanda.api.kconsole.v1alpha1.SecretService"
)
...
const (
	...
	SecretServiceGetSecretProcedure = "/redpanda.api.kconsole.v1alpha1.SecretService/GetSecret"
	// SecretServiceListSecretsProcedure is the fully-qualified name of the SecretService's ListSecrets
	// RPC.
	SecretServiceListSecretsProcedure = "/redpanda.api.kconsole.v1alpha1.SecretService/ListSecrets"
	// SecretServiceCreateSecretProcedure is the fully-qualified name of the SecretService's
	// CreateSecret RPC.
	SecretServiceCreateSecretProcedure = "/redpanda.api.kconsole.v1alpha1.SecretService/CreateSecret"
	// SecretServiceUpdateSecretProcedure is the fully-qualified name of the SecretService's
	// UpdateSecret RPC.
	SecretServiceUpdateSecretProcedure = "/redpanda.api.kconsole.v1alpha1.SecretService/UpdateSecret"
	// SecretServiceDeleteSecretProcedure is the fully-qualified name of the SecretService's
	// DeleteSecret RPC.
	SecretServiceDeleteSecretProcedure = "/redpanda.api.kconsole.v1alpha1.SecretService/DeleteSecret"
	// SecretServiceListSecretScopesProcedure is the fully-qualified name of the SecretService's
	// ListSecretScopes RPC.
	SecretServiceListSecretScopesProcedure = "/redpanda.api.kconsole.v1alpha1.SecretService/ListSecretScopes"
)
...
// SecretServiceClient is a client for the redpanda.api.kconsole.v1alpha1.SecretService service.
...
// NewSecretServiceClient constructs a client for the redpanda.api.kconsole.v1alpha1.SecretService
...
// GetSecret calls redpanda.api.kconsole.v1alpha1.SecretService.GetSecret.
...
// ListSecrets calls redpanda.api.kconsole.v1alpha1.SecretService.ListSecrets.
...
// CreateSecret calls redpanda.api.kconsole.v1alpha1.SecretService.CreateSecret.
...
// UpdateSecret calls redpanda.api.kconsole.v1alpha1.SecretService.UpdateSecret.
...
// DeleteSecret calls redpanda.api.kconsole.v1alpha1.SecretService.DeleteSecret.
...
// ListSecretScopes calls redpanda.api.kconsole.v1alpha1.SecretService.ListSecretScopes.
...
// SecretServiceHandler is an implementation of the redpanda.api.kconsole.v1alpha1.SecretService
// service.
...
func NewSecretServiceHandler(svc SecretServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.kconsole.v1alpha1.SecretService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSecretServiceHandler) GetSecret(context.Context, *connect.Request[v1alpha1.GetSecretRequest]) (*connect.Response[v1alpha1.GetSecretResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.SecretService.GetSecret is not implemented"))
}
...
func (UnimplementedSecretServiceHandler) ListSecrets(context.Context, *connect.Request[v1alpha1.ListSecretsRequest]) (*connect.Response[v1alpha1.ListSecretsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.SecretService.ListSecrets is not implemented"))
}
...
func (UnimplementedSecretServiceHandler) CreateSecret(context.Context, *connect.Request[v1alpha1.CreateSecretRequest]) (*connect.Response[v1alpha1.CreateSecretResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.SecretService.CreateSecret is not implemented"))
}
...
func (UnimplementedSecretServiceHandler) UpdateSecret(context.Context, *connect.Request[v1alpha1.UpdateSecretRequest]) (*connect.Response[v1alpha1.UpdateSecretResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.SecretService.UpdateSecret is not implemented"))
}
...
func (UnimplementedSecretServiceHandler) DeleteSecret(context.Context, *connect.Request[v1alpha1.DeleteSecretRequest]) (*connect.Response[v1alpha1.DeleteSecretResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.SecretService.DeleteSecret is not implemented"))
}
...
func (UnimplementedSecretServiceHandler) ListSecretScopes(context.Context, *connect.Request[v1alpha1.ListSecretScopesRequest]) (*connect.Response[v1alpha1.ListSecretScopesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.SecretService.ListSecretScopes is not implemented"))
}
