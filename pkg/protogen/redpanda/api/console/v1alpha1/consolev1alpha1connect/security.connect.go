...
const (
	...
	SecurityServiceName = "redpanda.api.kconsole.v1alpha1.SecurityService"
)
...
const (
	...
	// RPC.
	SecurityServiceListRolesProcedure = "/redpanda.api.kconsole.v1alpha1.SecurityService/ListRoles"
	// SecurityServiceCreateRoleProcedure is the fully-qualified name of the SecurityService's
	// CreateRole RPC.
	SecurityServiceCreateRoleProcedure = "/redpanda.api.kconsole.v1alpha1.SecurityService/CreateRole"
	// SecurityServiceGetRoleProcedure is the fully-qualified name of the SecurityService's GetRole RPC.
	SecurityServiceGetRoleProcedure = "/redpanda.api.kconsole.v1alpha1.SecurityService/GetRole"
	// SecurityServiceDeleteRoleProcedure is the fully-qualified name of the SecurityService's
	// DeleteRole RPC.
	SecurityServiceDeleteRoleProcedure = "/redpanda.api.kconsole.v1alpha1.SecurityService/DeleteRole"
	// SecurityServiceListRoleMembersProcedure is the fully-qualified name of the SecurityService's
	// ListRoleMembers RPC.
	SecurityServiceListRoleMembersProcedure = "/redpanda.api.kconsole.v1alpha1.SecurityService/ListRoleMembers"
	...
	SecurityServiceUpdateRoleMembershipProcedure = "/redpanda.api.kconsole.v1alpha1.SecurityService/UpdateRoleMembership"
)
...
// SecurityServiceClient is a client for the redpanda.api.kconsole.v1alpha1.SecurityService service.
...
// redpanda.api.kconsole.v1alpha1.SecurityService service. By default, it uses the Connect protocol
...
// ListRoles calls redpanda.api.kconsole.v1alpha1.SecurityService.ListRoles.
...
// CreateRole calls redpanda.api.kconsole.v1alpha1.SecurityService.CreateRole.
...
// GetRole calls redpanda.api.kconsole.v1alpha1.SecurityService.GetRole.
...
// DeleteRole calls redpanda.api.kconsole.v1alpha1.SecurityService.DeleteRole.
...
// ListRoleMembers calls redpanda.api.kconsole.v1alpha1.SecurityService.ListRoleMembers.
...
// UpdateRoleMembership calls redpanda.api.kconsole.v1alpha1.SecurityService.UpdateRoleMembership.
...
// SecurityServiceHandler is an implementation of the redpanda.api.kconsole.v1alpha1.SecurityService
// service.
...
func NewSecurityServiceHandler(svc SecurityServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.kconsole.v1alpha1.SecurityService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSecurityServiceHandler) ListRoles(context.Context, *connect.Request[v1alpha1.ListRolesRequest]) (*connect.Response[v1alpha1.ListRolesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.SecurityService.ListRoles is not implemented"))
}
...
func (UnimplementedSecurityServiceHandler) CreateRole(context.Context, *connect.Request[v1alpha1.CreateRoleRequest]) (*connect.Response[v1alpha1.CreateRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.SecurityService.CreateRole is not implemented"))
}
...
func (UnimplementedSecurityServiceHandler) GetRole(context.Context, *connect.Request[v1alpha1.GetRoleRequest]) (*connect.Response[v1alpha1.GetRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.SecurityService.GetRole is not implemented"))
}
...
func (UnimplementedSecurityServiceHandler) DeleteRole(context.Context, *connect.Request[v1alpha1.DeleteRoleRequest]) (*connect.Response[v1alpha1.DeleteRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.SecurityService.DeleteRole is not implemented"))
}
...
func (UnimplementedSecurityServiceHandler) ListRoleMembers(context.Context, *connect.Request[v1alpha1.ListRoleMembersRequest]) (*connect.Response[v1alpha1.ListRoleMembersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.SecurityService.ListRoleMembers is not implemented"))
}
...
func (UnimplementedSecurityServiceHandler) UpdateRoleMembership(context.Context, *connect.Request[v1alpha1.UpdateRoleMembershipRequest]) (*connect.Response[v1alpha1.UpdateRoleMembershipResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.SecurityService.UpdateRoleMembership is not implemented"))
}
