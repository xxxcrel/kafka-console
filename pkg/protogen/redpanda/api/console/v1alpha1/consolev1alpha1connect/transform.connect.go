...
const (
	...
	TransformServiceName = "redpanda.api.kconsole.v1alpha1.TransformService"
)
...
const (
	...
	// ListTransforms RPC.
	TransformServiceListTransformsProcedure = "/redpanda.api.kconsole.v1alpha1.TransformService/ListTransforms"
	// TransformServiceGetTransformProcedure is the fully-qualified name of the TransformService's
	// GetTransform RPC.
	TransformServiceGetTransformProcedure = "/redpanda.api.kconsole.v1alpha1.TransformService/GetTransform"
	// TransformServiceDeleteTransformProcedure is the fully-qualified name of the TransformService's
	// DeleteTransform RPC.
	TransformServiceDeleteTransformProcedure = "/redpanda.api.kconsole.v1alpha1.TransformService/DeleteTransform"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	transformServiceServiceDescriptor               = v1alpha1.File_redpanda_api_console_v1alpha1_transform_proto.Services().ByName("TransformService")
...
// TransformServiceClient is a client for the redpanda.api.kconsole.v1alpha1.TransformService
// service.
...
// redpanda.api.kconsole.v1alpha1.TransformService service. By default, it uses the Connect protocol
...
// ListTransforms calls redpanda.api.kconsole.v1alpha1.TransformService.ListTransforms.
...
// GetTransform calls redpanda.api.kconsole.v1alpha1.TransformService.GetTransform.
...
// DeleteTransform calls redpanda.api.kconsole.v1alpha1.TransformService.DeleteTransform.
...
// redpanda.api.kconsole.v1alpha1.TransformService service.
...
func NewTransformServiceHandler(svc TransformServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.kconsole.v1alpha1.TransformService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTransformServiceHandler) ListTransforms(context.Context, *connect.Request[v1alpha1.ListTransformsRequest]) (*connect.Response[v1alpha1.ListTransformsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.TransformService.ListTransforms is not implemented"))
}
...
func (UnimplementedTransformServiceHandler) GetTransform(context.Context, *connect.Request[v1alpha1.GetTransformRequest]) (*connect.Response[v1alpha1.GetTransformResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.TransformService.GetTransform is not implemented"))
}
...
func (UnimplementedTransformServiceHandler) DeleteTransform(context.Context, *connect.Request[v1alpha1.DeleteTransformRequest]) (*connect.Response[v1alpha1.DeleteTransformResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.kconsole.v1alpha1.TransformService.DeleteTransform is not implemented"))
}
