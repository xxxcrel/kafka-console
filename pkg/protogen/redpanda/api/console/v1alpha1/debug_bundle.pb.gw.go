...
func RegisterDebugBundleServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DebugBundleServiceServer) error {
	...
	mux.Handle("POST", pattern_DebugBundleService_GetClusterHealth_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.DebugBundleService/GetClusterHealth", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.DebugBundleService/GetClusterHealth"))
		if err != nil {
	...
	mux.Handle("POST", pattern_DebugBundleService_CreateDebugBundle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.DebugBundleService/CreateDebugBundle", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.DebugBundleService/CreateDebugBundle"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DebugBundleService_GetDebugBundleStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.DebugBundleService/GetDebugBundleStatus", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.DebugBundleService/GetDebugBundleStatus"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DebugBundleService_CancelDebugBundleProcess_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.DebugBundleService/CancelDebugBundleProcess", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.DebugBundleService/CancelDebugBundleProcess"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DebugBundleService_DeleteDebugBundleFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.DebugBundleService/DeleteDebugBundleFile", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.DebugBundleService/DeleteDebugBundleFile"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterDebugBundleServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DebugBundleServiceClient) error {
	...
	mux.Handle("POST", pattern_DebugBundleService_GetClusterHealth_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.DebugBundleService/GetClusterHealth", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.DebugBundleService/GetClusterHealth"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DebugBundleService_CreateDebugBundle_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.DebugBundleService/CreateDebugBundle", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.DebugBundleService/CreateDebugBundle"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DebugBundleService_GetDebugBundleStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.DebugBundleService/GetDebugBundleStatus", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.DebugBundleService/GetDebugBundleStatus"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DebugBundleService_CancelDebugBundleProcess_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.DebugBundleService/CancelDebugBundleProcess", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.DebugBundleService/CancelDebugBundleProcess"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DebugBundleService_DeleteDebugBundleFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.DebugBundleService/DeleteDebugBundleFile", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.DebugBundleService/DeleteDebugBundleFile"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_DebugBundleService_GetClusterHealth_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.DebugBundleService", "GetClusterHealth"}, ""))

	pattern_DebugBundleService_CreateDebugBundle_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.DebugBundleService", "CreateDebugBundle"}, ""))

	pattern_DebugBundleService_GetDebugBundleStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.DebugBundleService", "GetDebugBundleStatus"}, ""))

	pattern_DebugBundleService_CancelDebugBundleProcess_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.DebugBundleService", "CancelDebugBundleProcess"}, ""))

	pattern_DebugBundleService_DeleteDebugBundleFile_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.DebugBundleService", "DeleteDebugBundleFile"}, ""))
)
