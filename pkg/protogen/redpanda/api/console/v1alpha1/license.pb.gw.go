...
func RegisterLicenseServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LicenseServiceServer) error {
	...
	mux.Handle("POST", pattern_LicenseService_ListLicenses_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.LicenseService/ListLicenses", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.LicenseService/ListLicenses"))
		if err != nil {
	...
	mux.Handle("POST", pattern_LicenseService_SetLicense_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.LicenseService/SetLicense", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.LicenseService/SetLicense"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_LicenseService_ListEnterpriseFeatures_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.LicenseService/ListEnterpriseFeatures", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.LicenseService/ListEnterpriseFeatures"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterLicenseServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LicenseServiceClient) error {
	...
	mux.Handle("POST", pattern_LicenseService_ListLicenses_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.LicenseService/ListLicenses", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.LicenseService/ListLicenses"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_LicenseService_SetLicense_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.LicenseService/SetLicense", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.LicenseService/SetLicense"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_LicenseService_ListEnterpriseFeatures_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.LicenseService/ListEnterpriseFeatures", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.LicenseService/ListEnterpriseFeatures"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_LicenseService_ListLicenses_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.LicenseService", "ListLicenses"}, ""))

	pattern_LicenseService_SetLicense_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.LicenseService", "SetLicense"}, ""))

	pattern_LicenseService_ListEnterpriseFeatures_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.LicenseService", "ListEnterpriseFeatures"}, ""))
)
