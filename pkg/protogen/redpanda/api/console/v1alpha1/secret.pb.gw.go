...
func RegisterSecretServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SecretServiceServer) error {
	...
	mux.Handle("POST", pattern_SecretService_GetSecret_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecretService/GetSecret", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecretService/GetSecret"))
		if err != nil {
	...
	mux.Handle("POST", pattern_SecretService_ListSecrets_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecretService/ListSecrets", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecretService/ListSecrets"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecretService_CreateSecret_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecretService/CreateSecret", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecretService/CreateSecret"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecretService_UpdateSecret_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecretService/UpdateSecret", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecretService/UpdateSecret"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecretService_DeleteSecret_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecretService/DeleteSecret", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecretService/DeleteSecret"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecretService_ListSecretScopes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecretService/ListSecretScopes", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecretService/ListSecretScopes"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterSecretServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SecretServiceClient) error {
	...
	mux.Handle("POST", pattern_SecretService_GetSecret_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecretService/GetSecret", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecretService/GetSecret"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecretService_ListSecrets_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecretService/ListSecrets", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecretService/ListSecrets"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecretService_CreateSecret_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecretService/CreateSecret", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecretService/CreateSecret"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecretService_UpdateSecret_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecretService/UpdateSecret", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecretService/UpdateSecret"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecretService_DeleteSecret_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecretService/DeleteSecret", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecretService/DeleteSecret"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecretService_ListSecretScopes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecretService/ListSecretScopes", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecretService/ListSecretScopes"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_SecretService_GetSecret_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.SecretService", "GetSecret"}, ""))

	pattern_SecretService_ListSecrets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.SecretService", "ListSecrets"}, ""))

	pattern_SecretService_CreateSecret_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.SecretService", "CreateSecret"}, ""))

	pattern_SecretService_UpdateSecret_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.SecretService", "UpdateSecret"}, ""))

	pattern_SecretService_DeleteSecret_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.SecretService", "DeleteSecret"}, ""))

	pattern_SecretService_ListSecretScopes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.SecretService", "ListSecretScopes"}, ""))
)
