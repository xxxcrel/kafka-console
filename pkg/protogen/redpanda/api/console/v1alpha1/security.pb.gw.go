...
func RegisterSecurityServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SecurityServiceServer) error {
	...
	mux.Handle("POST", pattern_SecurityService_ListRoles_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecurityService/ListRoles", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecurityService/ListRoles"))
		if err != nil {
	...
	mux.Handle("POST", pattern_SecurityService_CreateRole_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecurityService/CreateRole", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecurityService/CreateRole"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecurityService_GetRole_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecurityService/GetRole", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecurityService/GetRole"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecurityService_DeleteRole_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecurityService/DeleteRole", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecurityService/DeleteRole"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecurityService_ListRoleMembers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecurityService/ListRoleMembers", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecurityService/ListRoleMembers"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecurityService_UpdateRoleMembership_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecurityService/UpdateRoleMembership", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecurityService/UpdateRoleMembership"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterSecurityServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SecurityServiceClient) error {
	...
	mux.Handle("POST", pattern_SecurityService_ListRoles_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecurityService/ListRoles", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecurityService/ListRoles"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecurityService_CreateRole_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecurityService/CreateRole", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecurityService/CreateRole"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecurityService_GetRole_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecurityService/GetRole", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecurityService/GetRole"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecurityService_DeleteRole_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecurityService/DeleteRole", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecurityService/DeleteRole"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecurityService_ListRoleMembers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecurityService/ListRoleMembers", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecurityService/ListRoleMembers"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SecurityService_UpdateRoleMembership_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/redpanda.api.kconsole.v1alpha1.SecurityService/UpdateRoleMembership", runtime.WithHTTPPathPattern("/redpanda.api.kconsole.v1alpha1.SecurityService/UpdateRoleMembership"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_SecurityService_ListRoles_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.SecurityService", "ListRoles"}, ""))

	pattern_SecurityService_CreateRole_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.SecurityService", "CreateRole"}, ""))

	pattern_SecurityService_GetRole_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.SecurityService", "GetRole"}, ""))

	pattern_SecurityService_DeleteRole_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.SecurityService", "DeleteRole"}, ""))

	pattern_SecurityService_ListRoleMembers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.SecurityService", "ListRoleMembers"}, ""))

	pattern_SecurityService_UpdateRoleMembership_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"redpanda.api.kconsole.v1alpha1.SecurityService", "UpdateRoleMembership"}, ""))
)
