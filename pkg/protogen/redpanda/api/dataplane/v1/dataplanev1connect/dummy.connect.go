...
const (
	...
	DummyServiceName = "redpanda.api.dataplane.v1.DummyService"
)
...
const (
	...
	// RPC.
	DummyServiceDummyMethodProcedure = "/redpanda.api.dataplane.v1.DummyService/DummyMethod"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	dummyServiceServiceDescriptor           = v1.File_redpanda_api_dataplane_v1_dummy_proto.Services().ByName("DummyService")
	dummyServiceDummyMethodMethodDescriptor = dummyServiceServiceDescriptor.Methods().ByName("DummyMethod")
)

// DummyServiceClient is a client for the redpanda.api.dataplane.v1.DummyService service.
type DummyServiceClient interface {
	// buf:lint:ignore RPC_REQUEST_STANDARD_NAME
	// buf:lint:ignore RPC_RESPONSE_STANDARD_NAME
	// buf:lint:ignore RPC_REQUEST_RESPONSE_UNIQUE
	DummyMethod(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[v1.DummyMethodResponse], error)
}

// NewDummyServiceClient constructs a client for the redpanda.api.dataplane.v1.DummyService service.
...
func NewDummyServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) DummyServiceClient {
	...
	return &dummyServiceClient{
		dummyMethod: connect.NewClient[emptypb.Empty, v1.DummyMethodResponse](
			httpClient,
...
type dummyServiceClient struct {
	dummyMethod *connect.Client[emptypb.Empty, v1.DummyMethodResponse]
}

// DummyMethod calls redpanda.api.dataplane.v1.DummyService.DummyMethod.
func (c *dummyServiceClient) DummyMethod(ctx context.Context, req *connect.Request[emptypb.Empty]) (*connect.Response[v1.DummyMethodResponse], error) {
	return c.dummyMethod.CallUnary(ctx, req)
}

// DummyServiceHandler is an implementation of the redpanda.api.dataplane.v1.DummyService service.
...
func NewDummyServiceHandler(svc DummyServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.dataplane.v1.DummyService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDummyServiceHandler) DummyMethod(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[v1.DummyMethodResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.dataplane.v1.DummyService.DummyMethod is not implemented"))
}
