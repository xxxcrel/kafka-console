...
const (
	...
	TransformServiceName = "redpanda.api.dataplane.v1.TransformService"
)
...
const (
	...
	// ListTransforms RPC.
	TransformServiceListTransformsProcedure = "/redpanda.api.dataplane.v1.TransformService/ListTransforms"
	// TransformServiceGetTransformProcedure is the fully-qualified name of the TransformService's
	// GetTransform RPC.
	TransformServiceGetTransformProcedure = "/redpanda.api.dataplane.v1.TransformService/GetTransform"
	// TransformServiceDeleteTransformProcedure is the fully-qualified name of the TransformService's
	// DeleteTransform RPC.
	TransformServiceDeleteTransformProcedure = "/redpanda.api.dataplane.v1.TransformService/DeleteTransform"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	transformServiceServiceDescriptor               = v1.File_redpanda_api_dataplane_v1_transform_proto.Services().ByName("TransformService")
...
// TransformServiceClient is a client for the redpanda.api.dataplane.v1.TransformService service.
type TransformServiceClient interface {
	ListTransforms(context.Context, *connect.Request[v1.ListTransformsRequest]) (*connect.Response[v1.ListTransformsResponse], error)
	GetTransform(context.Context, *connect.Request[v1.GetTransformRequest]) (*connect.Response[v1.GetTransformResponse], error)
	DeleteTransform(context.Context, *connect.Request[v1.DeleteTransformRequest]) (*connect.Response[v1.DeleteTransformResponse], error)
}

// NewTransformServiceClient constructs a client for the redpanda.api.dataplane.v1.TransformService
...
func NewTransformServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TransformServiceClient {
	...
	return &transformServiceClient{
		listTransforms: connect.NewClient[v1.ListTransformsRequest, v1.ListTransformsResponse](
			httpClient,
		...
		deleteTransform: connect.NewClient[v1.DeleteTransformRequest, v1.DeleteTransformResponse](
			httpClient,
...
type transformServiceClient struct {
	listTransforms  *connect.Client[v1.ListTransformsRequest, v1.ListTransformsResponse]
	getTransform    *connect.Client[v1.GetTransformRequest, v1.GetTransformResponse]
	deleteTransform *connect.Client[v1.DeleteTransformRequest, v1.DeleteTransformResponse]
}

// ListTransforms calls redpanda.api.dataplane.v1.TransformService.ListTransforms.
func (c *transformServiceClient) ListTransforms(ctx context.Context, req *connect.Request[v1.ListTransformsRequest]) (*connect.Response[v1.ListTransformsResponse], error) {
	return c.listTransforms.CallUnary(ctx, req)
}

// GetTransform calls redpanda.api.dataplane.v1.TransformService.GetTransform.
...
// DeleteTransform calls redpanda.api.dataplane.v1.TransformService.DeleteTransform.
func (c *transformServiceClient) DeleteTransform(ctx context.Context, req *connect.Request[v1.DeleteTransformRequest]) (*connect.Response[v1.DeleteTransformResponse], error) {
	return c.deleteTransform.CallUnary(ctx, req)
}

// TransformServiceHandler is an implementation of the redpanda.api.dataplane.v1.TransformService
// service.
...
func NewTransformServiceHandler(svc TransformServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.dataplane.v1.TransformService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTransformServiceHandler) ListTransforms(context.Context, *connect.Request[v1.ListTransformsRequest]) (*connect.Response[v1.ListTransformsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.dataplane.v1.TransformService.ListTransforms is not implemented"))
}
...
func (UnimplementedTransformServiceHandler) GetTransform(context.Context, *connect.Request[v1.GetTransformRequest]) (*connect.Response[v1.GetTransformResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.dataplane.v1.TransformService.GetTransform is not implemented"))
}

func (UnimplementedTransformServiceHandler) DeleteTransform(context.Context, *connect.Request[v1.DeleteTransformRequest]) (*connect.Response[v1.DeleteTransformResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.dataplane.v1.TransformService.DeleteTransform is not implemented"))
}
