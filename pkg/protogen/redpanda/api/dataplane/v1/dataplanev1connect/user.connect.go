...
const (
	...
	UserServiceName = "redpanda.api.dataplane.v1.UserService"
)
...
const (
	...
	UserServiceCreateUserProcedure = "/redpanda.api.dataplane.v1.UserService/CreateUser"
	// UserServiceUpdateUserProcedure is the fully-qualified name of the UserService's UpdateUser RPC.
	UserServiceUpdateUserProcedure = "/redpanda.api.dataplane.v1.UserService/UpdateUser"
	// UserServiceListUsersProcedure is the fully-qualified name of the UserService's ListUsers RPC.
	UserServiceListUsersProcedure = "/redpanda.api.dataplane.v1.UserService/ListUsers"
	// UserServiceDeleteUserProcedure is the fully-qualified name of the UserService's DeleteUser RPC.
	UserServiceDeleteUserProcedure = "/redpanda.api.dataplane.v1.UserService/DeleteUser"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	userServiceServiceDescriptor          = v1.File_redpanda_api_dataplane_v1_user_proto.Services().ByName("UserService")
...
// UserServiceClient is a client for the redpanda.api.dataplane.v1.UserService service.
...
// NewUserServiceClient constructs a client for the redpanda.api.dataplane.v1.UserService service.
...
// CreateUser calls redpanda.api.dataplane.v1.UserService.CreateUser.
...
// UpdateUser calls redpanda.api.dataplane.v1.UserService.UpdateUser.
...
// ListUsers calls redpanda.api.dataplane.v1.UserService.ListUsers.
...
// DeleteUser calls redpanda.api.dataplane.v1.UserService.DeleteUser.
...
// UserServiceHandler is an implementation of the redpanda.api.dataplane.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/redpanda.api.dataplane.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.dataplane.v1.UserService.CreateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.UpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.dataplane.v1.UserService.UpdateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListUsers(context.Context, *connect.Request[v1.ListUsersRequest]) (*connect.Response[v1.ListUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.dataplane.v1.UserService.ListUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect.Request[v1.DeleteUserRequest]) (*connect.Response[v1.DeleteUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("redpanda.api.dataplane.v1.UserService.DeleteUser is not implemented"))
}
