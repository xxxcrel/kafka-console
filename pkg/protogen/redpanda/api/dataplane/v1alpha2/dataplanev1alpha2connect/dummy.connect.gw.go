...
type DummyServiceGatewayServer struct {
	v1alpha2.UnimplementedDummyServiceServer
	dummyMethod connect_gateway.UnaryHandler[emptypb.Empty, v1alpha2.DummyMethodResponse]
}
...
func (s *DummyServiceGatewayServer) DummyMethod(ctx context.Context, req *emptypb.Empty) (*v1alpha2.DummyMethodResponse, error) {
...
func RegisterDummyServiceHandlerGatewayServer(mux *runtime.ServeMux, svc DummyServiceHandler, opts ...connect_gateway.HandlerOption) {
	if err := v1alpha2.RegisterDummyServiceHandlerServer(context.TODO(), mux, NewDummyServiceGatewayServer(svc, opts...)); err != nil {
