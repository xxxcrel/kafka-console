...
import (
	...
	"github.com/xxxcrel/kafka-console/pkg/proto/embed"
)
...
type Client interface {
	...
	ParseAvroSchemaWithReferences(ctx context.Context, schema sr.Schema, schemaCache *avro.SchemaCache) (avro.Schema, error)
